...
public class Game {
    ...
    public Game(int level) throws Exception {
        this(MazeBuilder.buildWalledMaze(level), level);
    }
    private Game(Maze maze, int level) {
        this(maze, new Pacman(maze), level);
    }
    private Game(Maze maze, Pacman pacman, int level) {
        this.maze = maze;
        this.pacman = pacman;
    ...
    public void advance(long timeDeltaInMillis) {
        ...
        pacman.advance(timeDeltaInMillis, level);
        ghosts.advance(timeDeltaInMillis, level);
