...
public class Game {
    ...
    public void advance(long timeDeltaInMillisPacman, long timeDeltaInMillisGhost) {
        if (pacman.isDead()) {
            return;
        }
        ...
        pacman.advance(timeDeltaInMillisPacman);
        ghosts.advance(timeDeltaInMillisGhost);
