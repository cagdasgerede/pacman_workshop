...
import com.thoughtworks.pacman.core.movement.TargetFeignUninterestMovementStrategy;
...
public enum GhostType {
    ...
    PINKY("ghost40.jpg", "ghost41.jpg",
            new SpacialCoordinate(14 * Tile.SIZE + Tile.SIZE / 2, 17 * Tile.SIZE + Tile.SIZE / 2)) {
        @Override
        public MovementStrategy getMovementStrategy(Game game) {
            return new RandomMovementStrategy(getStartCoordinate(), game.getMaze());
        }
    },
    INKY("ghost30.jpg", "ghost31.jpg",
            new SpacialCoordinate(12 * Tile.SIZE + Tile.SIZE / 2, 17 * Tile.SIZE + Tile.SIZE / 2)) {
        @Override
        public MovementStrategy getMovementStrategy(Game game) {
            return new RandomMovementStrategy(getStartCoordinate(), game.getMaze());
        }
    },
    CLYDE("ghost20.jpg", "ghost21.jpg",
            new SpacialCoordinate(16 * Tile.SIZE + Tile.SIZE / 2, 17 * Tile.SIZE + Tile.SIZE / 2)) {
        @Override
        public MovementStrategy getMovementStrategy(Game game) {
            return new TargetFeignUninterestMovementStrategy(getStartCoordinate(), game.getMaze(), game.getPacman());
        }
    };
